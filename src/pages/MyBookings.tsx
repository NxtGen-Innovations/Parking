                  ...
                  <CardContent className="p-5">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <div className="flex items-center gap-1 text-sm text-slate-500 mt-1"><MapPin size={14} />{booking.parking_spaces?.address_street}, {booking.parking_spaces?.city}</div>
                      </div>
                    ...
                    <div className="flex gap-6 mb-6 text-sm">
                      <div>
                        ...
                        <p className="font-semibold text-slate-700 flex items-center gap-2"><Calendar size={14} className="text-emerald-500"/> {new Date(booking.start_time).toLocaleDateString()} <span className="text-slate-300">|</span> {new Date(booking.start_time).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>
                      </div>
                      <div>
